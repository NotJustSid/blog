...
I've always wanted to come back to this place (perhaps because it's been one of those projects that lets me present things the way I like, and also one of those places I get to use to record my existence in time). It goes without saying there were "attempts" at coming back. Unfortunately some craziness ensued in this thing called *life*{: .tooltip data-tooltip="And all the chaos it brings along"} and things kept evolving. I'd be lying if I said they're not evolving still.
...
Yes, I did want to be all *high and mighty*{: .tooltip data-tooltip="Self-aware cringe intensifies"} with that title. Kinda the reason I came up with it. And it goes without saying that I have been implicitly aware of that "realization". Lessons definitely never lessen as long as we continue to grow in life. 
...
Honestly, I would've never imagined what 2025 brought to me on a silver platter. There have been significant shifts - *some good, some less so*{: .tooltip data-tooltip="Understatement of the year"} - including navigating the long-winded road of graduate school applications and all the craziness that ensued as a result of various external events. That journey still hasn't properly seen the light of day in the way I had originally envisioned, but perhaps that's the whole point of lessons, isn't it? They keep coming, and we keep adapting. 
...
So maybe - just *maybe*{: .tooltip data-tooltip="No promises, but we'll see"} - we'll spice that region up a bit more too. I have been thinking about how productivity systems and organizational tools interest me as well. Not sure if that warrants full posts yet, but who says this blog has to constrain itself to a single type of content? Heck, I've even been considering adding some *poetry*{: .tooltip data-tooltip="Yes, you read that right"} in the mix here and there. Who knows?
...
Thank you for tuning in! Sid out! See you (soon, pleeeease *manifesting no craziness and amazing timelines*{: .tooltip data-tooltip="Manifestation 101"} this time around) in the next one. 
